...
import Image from "next/image";
import { motion } from "framer-motion";
import { Star, Lightbulb, UserCheck, Clock } from "lucide-react"; // ← add these imports if not already present
...
function AnimatedCounter({ end, duration = 2.5, suffix = "+" }) {
  ...
  return (
    <div
      ref={ref}
      className="text-5xl md:text-6xl font-bold text-[#c2b790] mb-4"
    >
      <motion.span>{rounded}</motion.span>
      {suffix}
    </div>
...
const values = [
  {
    icon: Star, // Represents stars/trophy/experience
    title: "Proven Experience",
    description:
      "With 6+ years of expertise, we deliver top-tier interior fit-out & maintenance for residential, commercial & corporate projects.",
  },
  {
    icon: Lightbulb, // Classic for innovative/idea
    title: "Innovative Solutions",
    description:
      "We transform shell & core spaces into practical, elegant environments designed to inspire and last.",
  },
  {
    icon: UserCheck, // Represents dedicated service / client-focused / butler-like care
    title: "Dedicated Service",
    description:
      "Transparency and punctuality define our approach, ensuring every project is customized to exceed client expectations.",
  },
  {
    icon: Clock, // For on-time / punctuality
    title: "On-Time Delivery",
    description:
      "Punctuality is our core, ensuring every project meets deadlines with precision and quality for seamless execution.",
  },
];
...
//     title: "Our Mission",
//     description:
//       "To deliver innovative, high-quality interior solutions that transform spaces and exceed client expectations through transparency, precision, and dedication.",
//   },
//   {
//     icon: TrendingUp,
//     title: "Our Vision",
//     description:
//       "To be the leading provider of interior fit-out and maintenance solutions in the UAE, setting new industry standards through quality and innovation.",
//   },
//   {
//     icon: Award,
//     title: "Our Values",
//     description:
//       "Quality, transparency, punctuality, and exceptional service in every project. Building long-lasting partnerships through consistent delivery.",
//   },
//   {
//     icon: Users,
//     title: "Our Team",
//     description:
//       "Experienced professionals dedicated to transforming your vision into reality with precision craftsmanship and attention to detail.",
//   },
// ];
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <PageBanner
        title="About Us"
        subtitle="Your Trusted Partner in Interior Excellence"
        image="/images/about-section.png" // ← your local image (or change to any other)
      />

      {/* Who We Are Section */}
      <section ref={ref} className="relative py-12 md:py-26 lg:py-18 bg-white">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8 mt-10 md:mt-16">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            <motion.div
              initial={{ opacity: 0, y: 50 }}
            ...
            >
              ...
              <div className="space-y-6 text-gray-700">
                ...
                <p className="text-lg md:text-xl leading-relaxed">
                  ...
                  projects. Quality, punctuality and consistency in every
                  project.
                </p>

                <p className="text-lg md:text-xl leading-relaxed">
                  We focus on building transparent, long-term relationships with
                  our clients. Functional, beautiful environments tailored to
                  our clients unique requirements.
                </p>

                <p className="text-lg md:text-xl leading-relaxed">
                  With a commitment to transparency, quality & exceptional
                  service, we ensure that every project meets the highest
                  standards, making us a trusted partner for all interior
                  fit-out and maintenance needs.
                </p>
              </div>
            </motion.div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-5 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-10 md:mb-14">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#005369]">
              Our Core Values
            </h2>
            <div className="w-24 h-1 bg-[#c2b790] mx-auto mt-4" />
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 lg:gap-10">
            {values.map((value, idx) => (
              <div
                key={idx}
                className="group flex flex-col bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 overflow-hidden h-full"
              >
                {/* Icon Circle - fixed size */}
                <div className="pt-8 pb-6 flex justify-center">
                  <div className="w-20 h-20 rounded-full bg-[#005369] flex items-center justify-center transition-transform duration-300 group-hover:scale-105">
                    <value.icon
                      size={36}
                      className="text-[#c2b790]"
                      strokeWidth={2.5}
                ...
                {/* Content - flex-1 makes it stretch */}
                <div className="flex flex-col flex-1 px-6 pb-8 text-center">
                  <h3 className="text-xl md:text-2xl font-bold text-[#005369] mb-4">
                    {value.title}
                  </h3>
              ...
              return (
                <AnimatedSection key={idx} delay={idx * 100}>
                  <div className="bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105">
                    ...
                    <h3 className="text-2xl font-bold text-[#005369] mb-4">
                      {value.title}
                    </h3>
      ...
      {/* Why Choose Us - with Animated Counters */}
      <section className="py-12 md:py-20 bg-[#005369] text-white">
        <div className="container mx-auto px-6">
          <AnimatedSection>
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold">
          ...
          <div className="grid md:grid-cols-3 gap-12 md:gap-16">
            <AnimatedSection delay={100}>
              <div className="text-center">
                ...
                <p className="text-white">
                  Proven track record of excellence in the UAE market
                </p>
              </div>
            </AnimatedSection>
            ...
            <AnimatedSection delay={200}>
              <div className="text-center">
                ...
                <p className="text-white">
                  Successfully delivered across all sectors
                </p>
              </div>
            </AnimatedSection>
