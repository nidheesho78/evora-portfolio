        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div>
            ...
            <div className="mb-6 rounded-md">
              <Image
                src="/logo.png"
                alt="Evora Future Logo"
                width={180} // ← adjust width to match your logo's natural size
                height={60} // ← adjust height (maintain aspect ratio)
                className="bg-white rounded-lg p-2 md:p-3 shadow-sm"
                priority // optional: good for footer logo (LCP)
              />
            </div>
